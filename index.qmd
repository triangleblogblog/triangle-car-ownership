...
Let's pull in the census data necessary. Vehicles by Income is not tabulated in the ACS area releases so we'll need to use the microdata (2019 this case). Thus, we'll define the Triangle as all Census Public Usu Microdata Areas that intersect the Raleigh-Durham-Cary Combined Statistical Area:
